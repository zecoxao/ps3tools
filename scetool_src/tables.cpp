...
id_to_name_t _optional_header_types[] = 
{
	...
	{OPT_HEADER_TYPE_INDIV_SEED, "Individual Seed"},
	{OPT_HEADER_TYPE_CONTROL_FLAGS, "Control Flags"},
	{0, NULL}
};

/*! NP DRM types. */
id_to_name_t _np_drm_types[] = 
{
...
{
	{0x0000000100000001, "updater_frontend (lv1)"},
	{0x0000000100000002, "sc_iso"},
	{0x0000000100000005, "spu_pkg_rvk_verifier"},
	{0x0000000100006000, "update_manager_server (lv1)"},
	{0x0000000100009000, "sc_manager_server (lv1)"},
	{0x0000000100011000, "spm_server (lv1)"},
	{0x0000000100014000, "lv2_loader (lv1)"},
	{0x0000000100015000, "profile_loader (lv1)"},
	{0x0000000100016000, "pme_init (lv1)"},
	{0x0000000100017000, "individual_info_mgr_server (lv1)"},
	{0x0000000100018000, "dispatcher (lv1)"},
...
id_to_name_t _sign_algorithms[] = 
{
	{SIGN_ALGORITHM_ECDSA, "ECDSA"},
	{SIGN_ALGORITHM_SHA1_HMAC, "SHA1_HMAC"},
